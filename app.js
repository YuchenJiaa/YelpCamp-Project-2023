...
//fake a patch or delete method. in edit.ejs use ?_method=PUT
const methodOverride = require('method-override');
const passport = require('passport');
const LocalStrategy = require('passport-local');
//use user model
const User = require('./models/user');
//prohibit some symbol for security
...
//use ejs(a templating to show views) to embedded js
app.set('view engine', 'ejs');
app.set('views', path.join(__dirname, 'views'))
//It parses incoming requests with urlencoded payloads and is based on body-parser.
//show the post request, as a default, it will be undefined
    ...
    helmet.contentSecurityPolicy({
        ...
        directives: {
            ...
            imgSrc: [
                ...
                "blob:",
                "data:",
                "https://res.cloudinary.com/defkavl3g/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT! 
...
//we want to show a view in this route
app.get('/', (req, res) => {
    res.render('home')
});
